          ...
          <div class="slider-items-products">
            <div id="related-product-slider" class="product-flexslider hidden-buttons">
              <div class="slider-items slider-width-col4">
                @php
                $prod = App\ProductDetails::where('subcat_id',[$productdetails->subcat_id])->where('id','!=',[$productdetails->id])->orderBy('created_at','desc')->get()
                @endphp
                @foreach($prod as $prodet)
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      @if(!empty($prodet->discount) && ($prodet->discount) != 0)
                      <div class="icon-sale-label sale-left">{{substr((($prodet->price)-(($prodet->price)-($prodet->discount)))*100/($prodet->price),0,4)}}% off</div>
                      @endif
                      <div class="btn-quickview"> <a href="/product_details/{{$prodet->productname}}" style="text-transform:capitalize;"><span>{{ trans('app.view')}}</span></a></div>
                      ...
                      <a href="/product_details/{{$prodet->productname}}" class="product-item-photo">
                        @if($productdetails->photos != 'defaultimage.jpg')
                    ...
                    <div class="pro-box-info">
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a href="/product_details/{{$prodet->productname}}">{{substr($prodet->productname,0,25)}}
