...
function getdisc(){
  ...
  document.getElementById("discount").value = pr - res;
}
function getdisc1(){
  var disc = document.getElementById("discount").value;
  var pr = document.getElementById("price").value;
  document.getElementById("result").value = pr - disc;
}
$(document).ready(function(){
  $(document).on('change','.category', function(){
    ...
    $.ajax({
      ...
      success:function(data){
        op+='<option value="'+data[0].id+'" selected>'+data[0].name+'</option>';
